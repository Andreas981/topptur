...
import static no.hiof.andremi.topptur.MainActivity.TAG;
...
public class MainActivityRecyclerViewAdapter extends RecyclerView.Adapter<MainActivityRecyclerViewAdapter.ViewHolder>{
    ...
    public MainActivityRecyclerViewAdapter(ArrayList<String> mItem, Context mContext) {
        this.mItem = mItem;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.layout_listitem_mainactivity, viewGroup, false);
